...
public class DrawPaint {
    ...
    protected Paint getTexturePaint(TexturePaint fill, Graphics2D graphics) {
        ...
        try (InputStream is = fill.getImageData()) {
            ...
            if ( imgDim.getWidth() > textAnchor.getWidth() || imgDim.getHeight() > textAnchor.getHeight())
            {
                imgDim = new Dimension2DDouble(textAnchor.getWidth(), textAnchor.getHeight());
            }
            ...
            if (flip != null && flip != FlipMode.NONE) {
                ...
                final BufferedImage img = new BufferedImage((int) (width * flipX), (int) (height * flipY),
            ...
            return new DrawTexturePaint(renderer, image, s, fill, flipX, flipY,
                    renderer instanceof BitmapImageRenderer);
        } catch (IOException e) {
    ...
    private static BufferedImage colorizePattern(TexturePaint fill, BufferedImage pattern) {
        ...
        final IndexColorModel icm = new IndexColorModel(blendBits, blendShades, gradSample, 0, true, -1,
                DataBuffer.TYPE_BYTE);
        final BufferedImage patIdx = new BufferedImage(pattern.getWidth(), pattern.getHeight(),
     ...
     *
     * @see
     * <a href="https://msdn.microsoft.com/en-us/library/dd560821%28v=office.12%29.aspx">Using Office Open XML to Customize Document Formatting in the 2007 Office System</a>
     * @see
     * <a href="https://social.msdn.microsoft.com/Forums/office/en-US/040e0a1f-dbfe-4ce5-826b-38b4b6f6d3f7/saturation-modulation-satmod">saturation modulation (satMod)</a>
     * @see
     * <a href="http://stackoverflow.com/questions/6754127/office-open-xml-satmod-results-in-more-than-100-saturation">Office Open XML satMod results in more than 100% saturation</a>
     */
    ...
    protected Paint createLinearGradientPaint(GradientPaint fill, Graphics2D graphics) {
        ...
        final Point2D p1 = at.transform(new Point2D.Double(anchor.getCenterX() - diagonal / 2, anchor.getCenterY()),
                null);
...
//        snapToAnchor(p2, anchor);
    ...
    protected Paint createRadialGradientPaint(GradientPaint fill, Graphics2D graphics) {
        ...
        return safeFractions((f, c) -> new RadialGradientPaint(pCenter, radius, pFocus, f, c, CycleMethod.NO_CYCLE,
                ColorSpaceType.SRGB, at), fill);
    }
     ...
     *
     * @see
     * <a href="https://referencesource.microsoft.com/#PresentationCore/Core/CSharp/System/Windows/Media/Color.cs,1048">.Net implementation sRgbToScRgb</a>
     */
     ...
     *
     * @see
     * <a href="https://referencesource.microsoft.com/#PresentationCore/Core/CSharp/System/Windows/Media/Color.cs,1075">.Net implementation ScRgbTosRgb</a>
     */
    ...
    static void fillPaintWorkaround(Graphics2D graphics, Shape shape) {
        ...
        try {
            ...
            LOG.atWarn().withThrowable(e).log("IBM JDK failed with TexturePaintContext AIOOBE - " +
                    "try adding the following to the VM parameter:\n" +
                    "-Xjit:exclude={sun/java2d/pipe/AlphaPaintPipe.renderPathTile(Ljava/lang/Object;[BIIIIII)V} and " +
                    "search for 'JIT Problem Determination for IBM SDK using -Xjit' " +

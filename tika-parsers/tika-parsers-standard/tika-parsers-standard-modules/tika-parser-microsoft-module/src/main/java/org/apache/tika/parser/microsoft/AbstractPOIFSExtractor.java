...
abstract class AbstractPOIFSExtractor {
    ...
    protected void handleEmbeddedOfficeDoc(DirectoryEntry dir, XHTMLContentHandler xhtml,
                                           boolean outputHtml)
            throws IOException, SAXException, TikaException {
        handleEmbeddedOfficeDoc(0, dir, null, xhtml, outputHtml);
    }
    ...
    protected void handleEmbeddedOfficeDoc(DirectoryEntry dir, String resourceName,
                                           XHTMLContentHandler xhtml, boolean outputHtml)
            throws IOException, SAXException, TikaException {
        handleEmbeddedOfficeDoc(0, dir, resourceName, xhtml, outputHtml);
    }
    /**
     * Handle an office document that's embedded at the POIFS level
     */
    protected void handleEmbeddedOfficeDoc(int sourceId,
            DirectoryEntry dir, String resourceName, XHTMLContentHandler xhtml, boolean outputHtml)
            throws IOException, SAXException, TikaException {
        ...
        if (ooxml != null) {
            ...
            try (TikaInputStream stream = TikaInputStream
                ...
                handleEmbeddedResource(sourceId, stream, metadata, null, dir.getName(),dir.getStorageClsid(),

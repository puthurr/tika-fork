...
/**
 * Extractor for XSLF SlideShows - Low Level
 */
public class XSLFPowerPointExtractor extends SlideShowExtractor<XSLFShape, XSLFTextParagraph>
     ...
     * @return the extracted text
     */
    public static String getText(XSLFSlide slide, boolean slideText, boolean notesText, boolean commentText,
                                 boolean masterText) {

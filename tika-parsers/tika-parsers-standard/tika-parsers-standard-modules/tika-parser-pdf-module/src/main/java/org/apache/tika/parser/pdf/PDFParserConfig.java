...
public class PDFParserConfig extends BaseParserConfig implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return enableAutoSpace == config.enableAutoSpace &&
                ...
                Objects.equals(allPagesAsImages, config.allPagesAsImages) &&
                Objects.equals(firstPageAsCoverImage, config.firstPageAsCoverImage) &&
                Objects.equals(singlePagePDFAsImage, config.singlePagePDFAsImage) &&
                Objects.equals(stripedImagesHandling, config.stripedImagesHandling) &&
                stripedImagesThreshold == config.stripedImagesThreshold &&
                Objects.equals(graphicsToImage, config.graphicsToImage) &&
                graphicsToImageThreshold == config.graphicsToImageThreshold &&
                Objects.equals(jB2Images, config.jB2Images) &&
                jB2ImagesThreshold == config.jB2ImagesThreshold ;
    }
    ...
    public int hashCode() {
        return Objects.hash(userConfigured, enableAutoSpace, suppressDuplicateOverlappingText,
                ...
                setKCMS, detectAngles, renderer, allPagesAsImages,firstPageAsCoverImage,singlePagePDFAsImage,
                stripedImagesHandling, stripedImagesThreshold, graphicsToImage, graphicsToImageThreshold,
                jB2Images, jB2ImagesThreshold);
    }
